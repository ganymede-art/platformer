...
public class UserInterfaceMenuPauseController : MonoBehaviour
{
    ...
    private void SetMenu()
    {
        ...
        int main_count = master.dataController.GetItemCountByType(ITEM_TYPE_PRIMARY);
        int basic_count = master.dataController.GetItemCountByType(ITEM_TYPE_SECONDARY);
