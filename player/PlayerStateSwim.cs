...
{
    public class PlayerStateSwim : MonoBehaviour, IPlayerState
    {
        ...
        public void BeginState(PlayerController mc, params object[] parameters)
        {
            ...
            mc.playerAnimator.SetTrigger(TRIGGER_SWIM_BEGIN);
            ...
            if (mc.previousStateType != GameConstants.PLAYER_STATE_SWIM)
        ...
        {
            if (!mc.master.inputController.isInputWest)
        ...
        public void UpdateState(PlayerController mc)
        {
            ...
            mc.playerAnimator.SetFloat(TRIGGER_SPEED_MULTIPLIER, mc.rigidBody.velocity.magnitude / 2.0F);
        ...
        {
            return GameConstants.PLAYER_STATE_SWIM;
        }
    }
}
