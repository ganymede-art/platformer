...
public class RecoilMobState : MonoBehaviour, IState<Mob,MobStateId>
{
    // Private fields.
    ...
    public void BeginState(Mob c, Dictionary<string, object> args = null)
    {
        ...
        if (beginAudioSource != null)
            beginAudioSource.PlayPitchedOneShot
                (beginAudioSource.clip
