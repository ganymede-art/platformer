...
public class MoneyWidget : MonoBehaviour, IUserInterfaceWidget
{
    // Private fields.
    ...
    public UserInterfaceWidgetType WidgetType => UserInterfaceWidgetType.Money;
    ...
    public void BeginWidget(Dictionary<string, object> args = null)
    {
        ...
        if (statTextbox != null)
            statTextbox.text = $"{PlayerHighLogic.G.Money}";

        if (maxStatTextbox != null)
            maxStatTextbox.text = $"/{PlayerHighLogic.G.MaxMoney}";
    }
